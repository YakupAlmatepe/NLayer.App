...
namespace NLayer.WEB.Services
{
    public class ProductApiService
    {
        ...
        {
            var response = await _httpClient.GetFromJsonAsync<CustomeResponseDto<List<ProductWithCategoryDto>>>("products/GetProductsWithCategory");
        ...
        public async Task<ProductDto> GetByIdAsync(int id)
        {
            ...
            var response = await _httpClient.GetFromJsonAsync<CustomeResponseDto<ProductDto>>($"products/{id}");
            return response.Data;
